...
public class EntityPigFriendlyDiamond extends tm {
   private final pl aiControlledByPlayer;

   public EntityPigFriendlyDiamond(abw par1World) {
      super(par1World);
      this.a(0.9F, 0.9F);
      this.k().a(true);
      float f = 0.25F;
   ...
   public EntityPigFriendlyDiamond spawnBabyAnimal(nk par1EntityAgeable) {
      return new EntityPigFriendlyDiamond(this.q);
   }
