...
public class EntityPigFriendlyDiamond extends EntityMob
{

private final EntityAIControlledByPlayer aiControlledByPlayer;
    public EntityPigFriendlyDiamond(World par1World)
    {
        super(par1World);
        //texture = "/pigs/pigfriendlydiamond.png";
        setSize(0.9F, 0.9F);
        ...
        this.tasks.addTask(3, new EntityAITempt(this, 0.4F, Item.wheat.itemID, false));
...
/**
    ...
    */
	...
	public EntityPigFriendlyDiamond spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new EntityPigFriendlyDiamond(this.worldObj);
    }
