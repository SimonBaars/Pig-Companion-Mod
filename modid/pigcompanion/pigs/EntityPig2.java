...
public class EntityPig2 extends rp {
   private final pl aiControlledByPlayer;

   public EntityPig2(abw par1World) {
      super(par1World);
      this.a(0.9F, 0.9F);
      this.k().a(true);
      float f = 0.25F;
   ...
   public boolean a(uf par1EntityPlayer) {
      ...
      if (var2 != null && var2.d == yc.X.cv && this.b() >= 0) {
         this.x();
         if (!this.q.I) {
            EntityPigLeather var3 = new EntityPigLeather(this.q);
            var3.b(this.u, this.v, this.w, this.A, this.B);
            par1EntityPlayer.bn.d(yc.X.cv);
            var3.aN = this.aN;
            this.q.d(var3);
         }

         return true;
      } else if (var2 != null && var2.d == yc.af.cv && this.b() >= 0) {
         this.x();
         if (!this.q.I) {
            EntityPigIron var3 = new EntityPigIron(this.q);
            var3.b(this.u, this.v, this.w, this.A, this.B);
            par1EntityPlayer.bn.d(yc.af.cv);
            var3.aN = this.aN;
            this.q.d(var3);
         }

         return true;
      } else if (var2 != null && var2.d == yc.an.cv && this.b() >= 0) {
         this.x();
         if (!this.q.I) {
            EntityPigGold var3 = new EntityPigGold(this.q);
            var3.b(this.u, this.v, this.w, this.A, this.B);
            par1EntityPlayer.bn.d(yc.an.cv);
            var3.aN = this.aN;
            this.q.d(var3);
         }

         return true;
      } else if (var2 != null && var2.d == yc.aj.cv && this.b() >= 0) {
         this.x();
         if (!this.q.I) {
            EntityPigDiamond var3 = new EntityPigDiamond(this.q);
            var3.b(this.u, this.v, this.w, this.A, this.B);
            par1EntityPlayer.bn.d(yc.aj.cv);
            var3.aN = this.aN;
            this.q.d(var3);
         }
   ...
   public EntityPig2 spawnBabyAnimal(nk par1EntityAgeable) {
      return new EntityPig2(this.q);
   }
