...
public class RenderPigFriendlyLeather extends bhe {
   private static final bjo field_110888_a = new bjo("textures/entity/pig/pig_saddle.png");
   private static final bjo field_110887_f = new bjo("textures/pigs/pigfriendlyleather.png");

   public RenderPigFriendlyLeather(bbo par1ModelBase, bbo par2ModelBase, float par3) {
   ...
   protected bjo func_110886_a(EntityPigFriendlyLeather par1EntityPig) {
