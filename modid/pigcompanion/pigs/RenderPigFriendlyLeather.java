...
public class RenderPigFriendlyLeather extends RenderLiving
{
    ...
    {
        return renderSaddledPig((EntityPigFriendlyLeather)par1EntityLiving, par2, par3);
    }

    public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
    {
        func_40286_a((EntityPigFriendlyLeather)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        func_40286_a((EntityPigFriendlyLeather)par1Entity, par2, par4, par6, par8, par9);
    }
