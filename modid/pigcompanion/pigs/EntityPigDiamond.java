...
public class EntityPigDiamond extends rp {
   private final pl aiControlledByPlayer;

   public EntityPigDiamond(abw par1World) {
      super(par1World);
      this.a(0.9F, 0.9F);
      this.k().a(true);
      float f = 0.25F;
   ...
   public boolean a(uf par1EntityPlayer) {
      ...
      if (var2 != null && var2.d == yc.U.cv && this.b() >= 0) {
         this.x();
         if (!this.q.I) {
            EntityPigFriendlyDiamond var3 = new EntityPigFriendlyDiamond(this.q);
   ...
   public EntityPigDiamond spawnBabyAnimal(nk par1EntityAgeable) {
      return new EntityPigDiamond(this.q);
   }
