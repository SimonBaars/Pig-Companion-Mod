...
public class EntityPigFriendlyIron extends EntityMob
{
private final EntityAIControlledByPlayer aiControlledByPlayer;
    public EntityPigFriendlyIron(World par1World)
    {
        super(par1World);
        //texture = "/pigs/pigfriendlyiron.png";
        setSize(0.9F, 0.9F);
...
public int func_82193_c(Entity par1Entity)
	...
	public EntityPigFriendlyIron spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new EntityPigFriendlyIron(this.worldObj);
    }
	/**
