...
public class EntityPigFriendlyIron extends tm {
   private final pl aiControlledByPlayer;

   public EntityPigFriendlyIron(abw par1World) {
      super(par1World);
      this.a(0.9F, 0.9F);
      this.k().a(true);
      float f = 0.25F;
   ...
   public EntityPigFriendlyIron spawnBabyAnimal(nk par1EntityAgeable) {
      return new EntityPigFriendlyIron(this.q);
   }
