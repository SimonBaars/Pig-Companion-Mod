...
public class RenderPigFriendlyDiamond extends bhe {
   private static final bjo field_110888_a = new bjo("textures/entity/pig/pig_saddle.png");
   private static final bjo field_110887_f = new bjo("textures/pigs/pigfriendlydiamond.png");

   public RenderPigFriendlyDiamond(bbo par1ModelBase, bbo par2ModelBase, float par3) {
   ...
   protected bjo func_110886_a(EntityPigFriendlyDiamond par1EntityPig) {
   ...
   protected int shouldRenderPass(og par1EntityLiving, int par2, float par3) {
      return this.renderSaddledPig((EntityPigFriendlyDiamond)par1EntityLiving, par2, par3);
   }

   public void a(og par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
      this.func_40286_a((EntityPigFriendlyDiamond)par1EntityLiving, par2, par4, par6, par8, par9);
   }

   public void a(nn par1Entity, double par2, double par4, double par6, float par8, float par9) {
      this.func_40286_a((EntityPigFriendlyDiamond)par1Entity, par2, par4, par6, par8, par9);
   }
