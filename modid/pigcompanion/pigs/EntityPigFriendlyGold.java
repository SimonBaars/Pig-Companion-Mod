...
public class EntityPigFriendlyGold extends tm {
   private final pl aiControlledByPlayer;

   public EntityPigFriendlyGold(abw par1World) {
      super(par1World);
      this.a(0.9F, 0.9F);
      this.k().a(true);
      float f = 0.25F;
   ...
   public EntityPigFriendlyGold spawnBabyAnimal(nk par1EntityAgeable) {
      return new EntityPigFriendlyGold(this.q);
   }
