...
public class EntityPigIron extends EntityAnimal
{
private final EntityAIControlledByPlayer aiControlledByPlayer;
    public EntityPigIron(World par1World)
    {
        super(par1World);
        //texture = "/pigs/pigarmoriron.png";
        setSize(0.9F, 0.9F);
...
/**
    ...
    */
	...
	public EntityPigIron spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new EntityPigIron(this.worldObj);
    }
    */
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
		...
		if (var2 != null && var2.itemID == Items.wheat_seeds && this.getGrowingAge() >= 0)
        {
            ...
            {
                EntityPigFriendlyIron var3 = new EntityPigFriendlyIron(this.worldObj);
