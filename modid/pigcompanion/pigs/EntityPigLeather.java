...
public class EntityPigLeather extends rp {
   private final pl aiControlledByPlayer;

   public EntityPigLeather(abw par1World) {
      super(par1World);
      this.a(0.9F, 0.9F);
      this.k().a(true);
      float f = 0.25F;
   ...
   public boolean a(uf par1EntityPlayer) {
      ...
      if (var2 != null && var2.d == yc.U.cv && this.b() >= 0) {
         this.x();
         if (!this.q.I) {
            EntityPigFriendlyLeather var3 = new EntityPigFriendlyLeather(this.q);
   ...
   public EntityPigLeather spawnBabyAnimal(nk par1EntityAgeable) {
      return new EntityPigLeather(this.q);
   }
