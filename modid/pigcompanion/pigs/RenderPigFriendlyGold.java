...
public class RenderPigFriendlyGold extends RenderLiving
{
	private static final ResourceLocation field_110888_a = new ResourceLocation("textures/entity/pig/pig_saddle.png");
    private static final ResourceLocation field_110887_f = new ResourceLocation("textures/pigs/pigfriendlygold.png");
	
    public RenderPigFriendlyGold(ModelBase par1ModelBase, ModelBase par2ModelBase, float par3)
    {
    ...
    protected ResourceLocation func_110886_a(EntityPigFriendlyGold par1EntityPig)
    {
    ...
    {
        return renderSaddledPig((EntityPigFriendlyGold)par1EntityLiving, par2, par3);
    }

    public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
    {
        func_40286_a((EntityPigFriendlyGold)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        func_40286_a((EntityPigFriendlyGold)par1Entity, par2, par4, par6, par8, par9);
    }
